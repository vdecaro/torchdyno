...
_SCN_CARD = ModelCard(
    ...
    description="A block-diagonal contractive assembly (an RNN-of-RNNs) integrated with a fixed Euler step, trained end-to-end by backprop; the SCN baseline of Kozachkov et al.",
    admits=("backprop",),
    adapters=(),
